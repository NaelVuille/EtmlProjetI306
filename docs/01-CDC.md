...
liées au sport, à l'alimentation et au bien-être.
L'objectif de ce projet est de créer une application simple de suivi bien-être,
destinée à des étudiants, afin de mieux comprendre leurs habitudes
quotidiennes.
Dans ce module, vous allez développer une première version de cette
application en utilisant la méthodologie Scrum et l'outil AppSheet.
...
Il est autorisé de s'inspirer d'exemples ou de démonstrations, sans les
importer ni les dupliquer
...
L'utilisation d'outils d'intelligence artificielle (ex. ChatGPT, Gemini, etc.) est
autorisée, à condition de respecter les règles suivantes :
? Autorisé
...
Rétrospective de sprint (courte)
